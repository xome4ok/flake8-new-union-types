...
class TestZQ001:
    @pytest.mark.parametrize(("checker", "expected_errors"), [("zq001_1.py", 9), ("zq001_2.py", 9)], indirect=["checker"])
    def test_it_finds_union(self, checker: PEP604Checker, expected_errors: int) -> None:
        result = checker.run()
        errors = list(result)
